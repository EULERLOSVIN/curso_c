...
import csv
import math
from evaluar2 import evaluar_contrasena_entropia, calcular_entropia  # Importa las funciones desde evaluar2.py
...
def evaluacion_contraseña():
    contraseña = entry_contraseña.get()
    resultado = evaluar_contrasena_entropia(contraseña)  # Utiliza la función evaluar_contrasena_entropia desde evaluar2.py
