...
public class App extends JFrame {
    ...
    public App(){
        ...
        opciones = new JComboBox<String>();  // "JComboBox"  se utiliza para agregar opciones en el que el usuario pueda elegir una de ellas
        opciones.addItem("Alumno");   // primera opción
        opciones.addItem("Profesor"); // segunda opción
        opciones.addItem("Administrador"); // tercera opción
        opciones.setBounds(170,220,300,30); // pocición de las opc
        panel.add(opciones); // agregamos toda esta funcionalidad al panel ,es decir para hacerlo visual

        
        //................................................................................................
        boton1 = new JButton("Ingresar"); // boton que servirá para ingresar a la cuenta
        boton1.setBounds(255, 400, 100, 30); //posición del boton
        boton1.setBackground(Color.GREEN); // color del boton
        panel.add(boton1); // lo hacemos que paresca en la pantalla
